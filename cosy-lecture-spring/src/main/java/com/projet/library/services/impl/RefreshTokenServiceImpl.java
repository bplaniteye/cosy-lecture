...
import com.projet.library.repositories.RefreshTokenRepository;
...
public class RefreshTokenServiceImpl implements RefreshTokenService {
    ...
    public RefreshToken createRefreshToken(Integer userId) {
        LibraryUserEntity user = libraryUserRepository.findById(userId).orElseThrow(() -> new RuntimeException("User not found"));
    ...
    public RefreshTokenResponse generateNewToken(RefreshTokenRequest request) {
        LibraryUserEntity user = refreshTokenRepository.findByToken(request.getRefreshToken())
